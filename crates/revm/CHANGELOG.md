...
## [9.0.0](https://github.com/BigBenlau/revm_ben/compare/revm-v8.0.0...revm-v9.0.0) - 2024-05-02

### Added
- *(Handler)* Add ClearHandle ([#1368](https://github.com/BigBenlau/revm_ben/pull/1368))
- Add uniswap V2 WETH-USDC swap example ([#1353](https://github.com/BigBenlau/revm_ben/pull/1353))
...
- *(`db`)* Introduce `alloydb` ([#1257](https://github.com/BigBenlau/revm_ben/pull/1257))
...
- *(deps)* bump anyhow from 1.0.81 to 1.0.82 ([#1293](https://github.com/BigBenlau/revm_ben/pull/1293))
...
- add and use EvmContext::take_error ([#1264](https://github.com/BigBenlau/revm_ben/pull/1264))
